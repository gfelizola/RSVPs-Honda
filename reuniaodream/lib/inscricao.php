...
function inscricao_gera_excel()
{
	...
	foreach($inscricoes as $inscricao)
	{
		...
		foreach($concessionarias as $key => $conc)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $linha_concessionarias, html_entity_decode( $conc['str_assistencias_grupo'], ENT_COMPAT, 'ISO-8859-1' ));
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $linha_concessionarias, html_entity_decode( $conc['str_assistencias_nome_guerra'], ENT_COMPAT, 'ISO-8859-1' ));
